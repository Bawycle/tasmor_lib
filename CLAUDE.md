...
TasmoR Lib is a Rust library for controlling Tasmota devices via MQTT and HTTP protocols. It provides a type-safe async API built on Tokio. Current version: 0.10.0 (pre-1.0, API may change).
